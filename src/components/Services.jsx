...
const Services = () => {
  return (
    <div className="p-20 bg-slate-100 max-md:grid-cols-1 max-sm:grid-cols-1 max-sm:p-8" id="services">
      ...
      <div className="grid grid-cols-4 justify-center content-center gap-4 mt-5 max-lg:grid-cols-3 max-md:grid-cols-2 max-sm:grid-cols-1">
        <div className="border border-dark bg-slate-50 p-4 rounded-md hover:scale-105 transition cursor-pointer">
